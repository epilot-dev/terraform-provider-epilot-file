...
type SDK struct {
	SDKVersion string
	// Folder management for organizing files within entities
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.6.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.6.0 2.709.0 1.0.0 github.com/epilot-dev/terraform-provider-epilot-file/internal/sdk",
