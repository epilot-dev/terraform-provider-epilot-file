...
// Generated from OpenAPI doc version 1.10.0 and generator version 2.884.4
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.8.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.8.0 2.884.4 1.10.0 github.com/epilot-dev/terraform-provider-epilot-file/internal/sdk",
