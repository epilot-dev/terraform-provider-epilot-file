...
// Generated from OpenAPI doc version 1.4.0 and generator version 2.770.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.6.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.6.0 2.770.0 1.4.0 github.com/epilot-dev/terraform-provider-epilot-file/internal/sdk",
