...
// Generated from OpenAPI doc version 1.7.1 and generator version 2.812.2
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.8.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.8.0 2.812.2 1.7.1 github.com/epilot-dev/terraform-provider-epilot-file/internal/sdk",
