...
// Generated from OpenAPI doc version 1.13.0 and generator version 2.924.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.8.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.8.0 2.924.0 1.13.0 github.com/epilot-dev/terraform-provider-epilot-file/internal/sdk",
